...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "HealthXenseAppPWA"; //Local Storage Names for PWA
		...
		*/
        ...
        function highlightColors(){
            ...
            highlightData.forEach(el => el.addEventListener('click', e =>{
                ...
                loadHighlight.href = '../hxassets/hxcss/highlights/highlight_' + highlight +'.css';
            ...
            if(rememberHighlight){
                ...
                loadHighlight.className = "page-highlight";
                loadHighlight.type = "text/css";
                loadHighlight.href = '../hxassets/hxcss/highlights/highlight_' + rememberHighlight +'.css';
